    ...
    <aside class="left-sidebar with-vertical">
        <div><!-- ---------------------------------- -->
            ...
            <div class="brand-logo d-flex align-items-center justify-content-between">
                {{--                <h3>GBV</h3>--}}
                <a href="{{ route('counsel-dashboard') }}" class="text-nowrap logo-img">
            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar>
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('counsel-dashboard') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-home"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('counsel-cases') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-file"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('counsel-pending-cases') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-clock-hour-4"></i>
                </span>
                            <span class="hide-menu">Pending Sessions</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('counsel-solved-cases') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-file-check"></i>
                </span>
                            <span class="hide-menu">Completed Sessions</span>
                        </a>
                    </li>
                    <li class="nav-small-cap">
                        <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('counsel-reports') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-clipboard-check"></i>
                </span>
                            <span class="hide-menu">Counseling Reports</span>
                        </a>
                    </li>
                    <li class="nav-small-cap">
                        <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('counsel-settings') }}" aria-expanded="false">
                <span>
                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Counselor</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a class="text-muted text-decoration-none" href="{{ route('counsel-dashboard') }}">Home</a>
                                            </li>
