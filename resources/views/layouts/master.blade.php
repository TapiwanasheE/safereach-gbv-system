...
<head>
    ...
    <!-- Favicon icon-->
    <link rel="shortcut icon" type="image/png" href="{{ asset('assets/images/logos/gbv image.png') }}"/>

    <!-- Core Css -->
    <link rel="stylesheet" href="{{ asset('assets/css/styles.css') }}"/>

    <title>Safe Reach (GBV) - Super Admin</title>
    <!-- Owl Carousel  -->
...
{{--                <h3>GBV</h3>--}}
                <a href="{{ route('sa-dashboard') }}" class="text-nowrap logo-img">
            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar>
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('sa-dashboard') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-home"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('sa-cases-index') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-clipboard-list"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('sa-users') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-users"></i>
                </span>
                            <span class="hide-menu">System Staff</span>
                        </a>
                    </li>
                    <li class="nav-small-cap">
                        <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('sa-reports') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-file-chart"></i>
                </span>
                            <span class="hide-menu">System Reports</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('sa-audit-logs') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-history"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('sa-roles') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-shield-lock"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('sa-settings') }}" aria-expanded="false">
                <span>
                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">System Admin</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a class="text-muted text-decoration-none" href="{{ route('sa-dashboard') }}">Home</a>
                                            </li>
