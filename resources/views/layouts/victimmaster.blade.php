            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar>
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('vic-dashboard') }}"  aria-expanded="false">
                <span>
                  <i class="ti ti-home"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('vic-create-case') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-edit"></i>
                </span>
                            <span class="hide-menu">Report Case</span>
                        </a>
                    </li>
                    <li class="nav-small-cap">
                        <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('vic-my-cases') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-file"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('vic-resources') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-file-check"></i>
                </span>
                            <span class="hide-menu">GBV Support Materials</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
