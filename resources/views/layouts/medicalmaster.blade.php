...
<head>
    ...
    <title>Safe Reach (GBV) - Medical</title>
    <!-- Owl Carousel  -->
    ...
    <aside class="left-sidebar with-vertical">
        <div><!-- ---------------------------------- -->
            ...
            <div class="brand-logo d-flex align-items-center justify-content-between">
                {{--                <h3>GBV</h3>--}}
                <a href="{{ route('med-dashboard') }}" class="text-nowrap logo-img">
            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar>
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('med-dashboard') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-home"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('med-cases') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-file"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('med-pending-cases') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-loader"></i>
                </span>
                            <span class="hide-menu">Pending Reviews</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('med-solved-cases') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-file-check"></i>
                </span>
                            <span class="hide-menu">Completed Reviews</span>
                        </a>
                    </li>
                    <li class="nav-small-cap">
                        <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('med-reports') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-clipboard-check"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('med-settings') }}" aria-expanded="false">
                <span>
                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Medical</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a class="text-muted text-decoration-none" href="{{ route('med-dashboard') }}">Home</a>
                                            </li>
