        ...
        <div class="container-fluid">
            ...
            <div class="card bg-success-subtle shadow-none position-relative overflow-hidden mb-4">
                <div class="card-body px-4 py-3">
                    <div class="row align-items-center">
                        <div class="col-9">
                            <h4 class="fw-semibold mb-8">Solved Cases</h4>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">
                                        <a class="text-muted text-decoration-none" href="{{ route('law-dashboard') }}">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">Solved Cases</li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="fw-semibold mb-0">{{ $cases->total() }} Solved Cases</h4>
                                    <p class="text-muted mb-0">Successfully resolved and closed cases</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0 text-white"><i class="ti ti-file-check"></i> Solved Cases List</h5>
                </div>
                <div class="card-body">
                    @if($cases->count() > 0)
                                ...
                                <tbody>
                                    @foreach($cases as $case)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('law-cases-show', $case->id) }}" class="btn btn-sm btn-success">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h5 class="text-muted mt-3">No Solved Cases</h5>
                            <p class="text-muted">There are currently no closed cases in the system.</p>
                        </div>
                    @endif
                </div>
            </div>
