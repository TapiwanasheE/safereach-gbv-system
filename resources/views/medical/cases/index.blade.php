...
@section('content')
    <div class="body-wrapper">
        <div class="container-fluid">
            ...
            <div class="card bg-primary-subtle shadow-none position-relative overflow-hidden mb-4">
                <div class="card-body px-4 py-3">
                    <div class="row align-items-center">
                        <div class="col-9">
                            <h4 class="fw-semibold mb-8">Medical Cases</h4>
                        ...
                        <div class="col-3 text-end">
                            <i class="ti ti-medical-cross" style="font-size: 50px; opacity: 0.5;"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-3">Assigned Cases</h5>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <p class="fs-4 fw-semibold mb-0 text-primary">{{ $case->case_number }}</p>
                                    ...
                                    <td>
                                        @if($case->status == 'Medical Review Done')
                                            <span class="badge bg-success"><i class="ti ti-check"></i> Review Completed</span>
                                        @else
                                            <span class="badge bg-warning"><i class="ti ti-clock"></i> Pending Review</span>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{ route('med-case-show', $case->id) }}" class="btn btn-sm btn-primary">
                    ...
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">You currently have no medical cases assigned to you.</p>
                    </div>
                    @endif
                </div>
            </div>
