        ...
        <div class="container-fluid">
            ...
            <div class="card bg-warning-subtle shadow-none position-relative overflow-hidden mb-4">
                <div class="card-body px-4 py-3">
                    <div class="row align-items-center">
                        <div class="col-9">
                            <h4 class="fw-semibold mb-8">Pending Medical Reviews</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="fw-semibold mb-0">{{ $cases->total() }} Pending Reviews</h4>
                                    <p class="text-muted mb-0">Cases awaiting medical examination and review</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-header bg-warning text-white">
                    <h5 class="mb-0 text-white"><i class="ti ti-medical-cross"></i> Pending Medical Cases</h5>
                </div>
                <div class="card-body">
                    @if($cases->count() > 0)
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h5 class="text-muted mt-3">No Pending Reviews</h5>
                            <p class="text-muted">All assigned cases have been reviewed.</p>
                        </div>
                    @endif
                </div>
            </div>
